...
public class ServerVirtualThreadsTest {

    @Test
    public void testSendCombinedCardDetails() throws IOException, ExecutionException, InterruptedException {
        ...
        ServerVirtualThreads server = new ServerVirtualThreads();
